...
CLIENT_SECRETS_FILE = '/Users/mgravier/Desktop/Senior/client_secret.json'
...
def get_comment_threads(youtube, video_id):
  ...
  for item in results["items"]:
    ...
    print(texts)
    bigStr = ''.join(texts)
    commentFile.write(bigStr.encode('utf-8'))
  commentFile.close()
  ...
  outputCat = open('commentsCat.json', 'w')
  outputCat.write(json.dumps(response, indent=2))
  outputCat.close()

  outputData = open('commentsCat.json', 'r')
  outputDic = json.load(outputData)
  catFile = open('commentsCatFile.txt', 'w')
...
if __name__ == "__main__":
  ...
  try:
    ...
    print "Done categorizing comments."
